...
・少量（60g、約96kcal）→ 120kcal未満 → 0カウント
・1人前（100g、約160kcal）→ 120〜200kcal → 0.5カウント
・大盛り（150g、約240kcal）→ 200kcal超 → 1カウント

【鶏レバー・ハツ（B食材：100gあたり約120〜145kcal）】
・小皿少量（30〜40g、約45〜55kcal）→ 120kcal未満 → 0カウント
・1人前（100g、約120〜145kcal）→ 120〜200kcal → 0.5カウント
...
【計算例】
- 鶏もも唐揚げ1人前（100g）
  ① 鶏もも肉（B食材、100gで約160kcal）→ 120〜200kcal → 0.5カウント
  ② 衣 → 0カウント
...
- 牛乳（100mlあたり約67kcal）→ 180ml未満なら0カウント、180〜300mlなら0.5、300ml超なら1カウント
...
- 小さじ1〜大さじ1未満（〜110kcal）→ 120kcal未満 → 0カウント
- 大さじ1〜大さじ1.5（約110〜165kcal）→ 120〜200kcal → 0.5カウント（大さじ1強以上）
- 大さじ2以上（約220kcal）→ 200kcal超 → 1カウント
- 炒め物の油（小さじ1〜2程度、約40〜80kcal）→ 0カウント
